...
//     version 1.17.0
//     from Assets/SoilInput.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/SoilInput.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @SoilInput: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ""maps"": [
        {
            ""name"": ""Testing"",
            ""id"": ""da08adac-13cb-41b1-8f27-c595261de4af"",
            ""actions"": [
                {
                    ""name"": ""Dig"",
                    ""type"": ""Button"",
                    ""id"": ""ef187f0d-46b0-4dfc-956d-10e16252f417"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""a1331523-ece0-471c-919c-dee2f5c5403e"",
    ...
    ~@SoilInput()
    {
        UnityEngine.Debug.Assert(!m_Testing.enabled, "This will cause a leak and performance issues, SoilInput.Testing.Disable() has not been called.");
    }
    ...
    {
        private @SoilInput m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public TestingActions(@SoilInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
